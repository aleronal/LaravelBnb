<template>
    <div class="row">
        ...
        <div class="col-md-4 pd-4">
           ...
           <div v-if="inBasketAlready" class="mt-4 text-muted warning">Seems like you've added this object this basket already if you want to change dates remove from basket</div>
